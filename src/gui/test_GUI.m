...
% Last Modified by GUIDE v2.5 28-Apr-2015 15:01:47
...
%functions automatically generated by GUIDE to build GUI
...
%FIXME: manchmal die erweiterte suche nicht möglich
% Warning: Single-selection 'listbox' control
% requires that 'Value' be an integer within
% String range
% Control will not be rendered until all of
% its parameter values are valid 

%functions generated by GUIDE and extended with own code
...
if isempty(fileNames) ==0
    ...
    set(handles.listboxResults,'string',['Keine Ergebnisse für ' stringToSearchFor],'value',1);
end
...
%shows sentences of selected file in static text box
